...
Mobile.setText(findTestObject('CicleApp/CreateName-txtbox'), 'New Company', 0)
...
Mobile.verifyElementAttributeValue(findTestObject('CicleApp/successMessage-text'), 'content-desc', 'Successfully create company user', 
    0)
